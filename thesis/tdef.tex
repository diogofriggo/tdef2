...
%a sua viabilidade e maximizar a geração a partir de medições que estão sujeitas às diversas variáveis que definem o comportamento do vento no local tais como orografia, rugosidade e clima. Estes também devem considerar variáveis que afetam o desempenho de turbinas tais como temperatura, salinidade e presença de parques vizinhos. 
...
\begin{figure}[h]
	...
	%.\\Fonte: Boletim anual de Geração Eólica disponível
\end{figure}
\FloatBarrier
